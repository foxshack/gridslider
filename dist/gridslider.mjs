 ...
 * @param {Function} func
 * @param  {...any} args
 */ const $d48e1cd1057d96ba$var$onScrollEnd = function (
  element,
  func,
  ...args
) {
 ...
 * @param {*} offset
 * @returns
 */ const $d48e1cd1057d96ba$var$itemLeftOfParent = (
  element,
  parent,
  offset,
) => {
 ...
 * and grid items.
 * @param {*} element
 */ $d48e1cd1057d96ba$var$glider.init = function ({
  element: element,
  gridSelector: gridSelector = "[data-glider-grid]",
  pagerSelector: pagerSelector = "[data-glider-pager]",
  itemSelector: itemSelector = "[data-glider-item]",
  nextButtonSelector: nextButtonSelector = '[data-glider-nav="next"]',
  prevButtonSelector: prevButtonSelector = '[data-glider-nav="prev"]',
  startButtonSelector: startButtonSelector = '[data-glider-nav="start"]',
  endButtonSelector: endButtonSelector = '[data-glider-nav="end"]',
} = {}) {
  this.glider = element;
...
$d48e1cd1057d96ba$var$glider.generatePagerLink = function (
  pageNumber,
  itemNumber,
) {
...
$d48e1cd1057d96ba$var$glider.updateActivePage = function () {
  ...
  if (
    $d48e1cd1057d96ba$var$withinViewport(
  ...
  for (let i = 0; i < scrollIndex.length; i++)
    if (
      $d48e1cd1057d96ba$var$itemLeftOfParent(
        this.items[scrollIndex[i]],
        this.grid,
        16,
      )
    )
 ...
 */ $d48e1cd1057d96ba$var$glider.initPager = function () {
  ...
  window.addEventListener(
    "resize",
    $d48e1cd1057d96ba$var$debounce(function () {
      that.refreshLayout();
    }, 250),
  );
  this.refreshLayout();
...
const $d48e1cd1057d96ba$var$initGlider = function ({
  sliderSelector: sliderSelector = "[data-glider]",
} = {}) {
...
export {
  $d48e1cd1057d96ba$export$5c49591af2a4b68b as makeGlider,
  $d48e1cd1057d96ba$export$2e2bcd8739ae039 as default,
};
